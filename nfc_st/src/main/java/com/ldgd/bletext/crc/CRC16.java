...
public class CRC16 {
	    ...
	    public static int calcCrc16(byte[] data, int offset, int len, int preval) {  
	        int ucCRCHi = (preval & 0xff00) >> 8;  //0xffff & 0xff00= 1111 1111 0000 0000>>8=0000 0000 1111 1111
	        int ucCRCLo = preval & 0x00ff; //0000 0000 1111 1111
	        int iIndex;  
	        for (int i = 0; i < len; ++i) {  
	    ...
	    public static void main(String[] args) {  
	    	...
	    	//0x7E, 0x00 ,0x05 ,0x60 ,0x31 ,0x32 ,0x33
	        int crc = CRC16.calcCrc16(new byte[] { 17,18,19,20 });  
