...
public class SlidingTabLayout2 extends HorizontalScrollView {
    ...
    //选项卡的扩展布局 权重为1
    private LinearLayout.LayoutParams extendTabLayoutParams;
    ...
    public SlidingTabLayout2(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabHeight = (int)TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, tabHeight, dm);

        mTabStrip = new SlidingTabStrip2(context);
        addView(mTabStrip, LayoutParams.MATCH_PARENT, tabHeight);
        mTabStrip.setBackgroundColor(getResources().getColor(R.color.tabBackgroundColor));

        //初始化布局
        defaultTabLayoutParams = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT);
        extendTabLayoutParams = new LinearLayout.LayoutParams(0, tabHeight, 1.0f);
    ...
    protected TextView createDefaultTabView(Context context) {
        ...
        LogUtil.e("Build.VERSION.SDK_INT >= Build.VERSION_CODES. = " + (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB));
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            mTabStrip.addView(tabView, i, shouldExpand ? extendTabLayoutParams : defaultTabLayoutParams);
        }
    }
        ...
        /*    selectedTitle.setBackgroundColor(Color.WHITE);
            for(int i = 0;i<tabStripChildCount;i++){
                if(i==position){
                    ...
                    TextView otherView =(TextView) mTabStrip.getChildAt(i);
                    otherView.setBackgroundColor( Color.argb(220, Color.red(110), Color.green(202), Color.blue(199)));
                }
            }
*/
